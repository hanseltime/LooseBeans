...
/**
 * Annotation used to indicate a certain method is associated as the getter
 * for a {@link BeanProperty} with the same semantic name for the given class and its super classes.
 * <p>
 * This Annotation can be applied to Both IndexGetter Methods and normal getter methods.
 * <p>
